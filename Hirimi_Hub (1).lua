...
ImageButton1.Image = "rbxassetid://15767690430"
...
function Update:Window(text,logo,keybind)
    ...
    function main:AddButton(text, callback)
        ...
        ImageButton.Image = "rbxassetid://15767690430"
    ...
    function main:AddToggle(TogInfo ,default, callback)
        ...
        ImageLabel.Image = "rbxassetid://15767690430"
...
H:AddLabel("Code By Sơn")

H:AddLabel("Light X Hub Discord")
H:AddLabel("https://discord.gg/2FtUG72Cxz")
H:AddLabel("Discord: Sơn Vjp Pờ Gồ :)))")
 

H:AddButton("Youtube Light X Hub",function()
setclipboard("https://youtube.com/@GiaTocFreeFire3311")
game.StarterGui:SetCore("SendNotification", {
      Icon = "rbxassetid://15767690430";
      Title = "Light X Hub", 
      Text = "Copied";
})
end)
